...
echo "  python3 /opt/election-lab/containment/contain.py isolate  --target 172.21.20.10"
echo "  python3 /opt/election-lab/containment/contain.py block-ip --ip 172.21.10.10"
echo "  python3 /opt/election-lab/containment/contain.py snapshot --container lab-election-db"
echo "  python3 /opt/election-lab/containment/contain.py status"
echo "  bash /opt/election-lab/containment/recovery.sh all"
echo ""
