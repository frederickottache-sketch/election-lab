...
echo "  python3 /opt/election-lab/legal/check_compliance.py --incident-date 2024-11-05T14:32:00 --state TX"
echo "  cat /opt/election-lab/legal/notifications/voter_notification.txt"
echo "  cat /opt/election-lab/legal/comms/press_release.txt"
echo ""
