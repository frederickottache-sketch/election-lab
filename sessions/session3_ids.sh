...
echo -e "${BOLD} Exercise 3.1:${RESET}"
echo -e "${CYAN}sudo snort -A console -c /etc/snort/snort.conf -i ${INTERNAL_IFACE} ${RESET}"
echo ""
echo -e "${BOLD} Exercise 3.2:${RESET}"
echo -e "${CYAN}python3 /opt/election-lab/threat-intel/ioc_store.py search election${RESET}"
echo ""
echo -e "${BOLD} Exercise 3.3:${RESET}"
echo -e "${CYAN}python3 /opt/election-lab/threat-intel/ioc_store.py export${RESET}"
echo ""
echo -e "${BOLD} Exercise 3.4:${RESET}"
echo -e "${CYAN}cat /var/log/snort/alert${RESET}"
echo ""
