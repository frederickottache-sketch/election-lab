...
echo "  python3 /opt/election-lab/attack-sim/attack_scenario.py --phase full-chain"
echo "  python3 /opt/election-lab/attack-sim/attack_scenario.py --phase recon"
echo "  curl 'http://localhost:9200/election-security-events/_search?pretty'"
echo "  http://localhost:5601  (Kibana — search election-security-*)"
echo ""
